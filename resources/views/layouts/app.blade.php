    ...
    <footer class="mt-20 border-t border-ink/10 bg-paper-dim">
        <div class="max-w-[1600px] mx-auto px-5 sm:px-8 py-10 grid sm:grid-cols-2 lg:grid-cols-4 gap-8 text-sm">
            <div>
                ...
                <p class="text-ink-soft leading-relaxed">Karang Taruna RW 040<br>Perumahan Panorama Wanasari<br>Cibitung, Bekasi, Jawa Barat</p>
            </div>
            <div>
            ...
            <div>
                ...
                <ul class="space-y-2 text-ink-soft">
                    <li>
                        <a href="https://www.instagram.com/_dfourty?igsh=ejZ4NzhyeGFxbTYz" target="_blank" rel="noopener noreferrer" class="flex items-center gap-2 hover:text-brick transition-colors">
                    ...
                    <li>
                        <a href="https://www.tiktok.com/@kartarpanorama040?_r=1&_t=ZS-98CO1n3PPHA" target="_blank" rel="noopener noreferrer" class="flex items-center gap-2 hover:text-brick transition-colors">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
                    ...
                    <li>
                        <a href="https://mail.google.com/mail/?view=cm&fs=1&to=panoramasehat@gmail.com" target="_blank" rel="noopener noreferrer" class="flex items-center gap-2 hover:text-brick transition-colors">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
                                <path d="M0 4a2 2 0 0 1 2-2h12a2 2 0 0 1 2 2v8a2 2 0 0 1-2 2H2a2 2 0 0 1-2-2V4Zm2-1a1 1 0 0 0-1 1v.217l7 4.2 7-4.2V4a1 1 0 0 0-1-1H2Zm13 2.383-4.708 2.825L15 11.105V5.383Zm-.034 6.876-5.64-3.471L8 9.583l-1.326-.795-5.64 3.47A1 1 0 0 0 2 13h12a1 1 0 0 0 .966-.741ZM1 11.105l4.708-2.897L1 5.383v5.722Z"/>
                            </svg>
                            panoramasehat@gmail.com
                        </a>
                    </li>
                    <li>
                        <a href="https://wa.me/6282129618758" target="_blank" rel="noopener noreferrer" class="flex items-center gap-2 hover:text-brick transition-colors">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
